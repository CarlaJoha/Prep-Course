...
function cuentoElementos(arreglo){
  ...
  for (let i = 0; i < arreglo.length; i++){
    if (arreglo[i] > 18){
      arrMayorQue.push(arreglo[i]);
    }
  } return arrMayorQue.length;
}
...
function continueStatement(numero) {
  //Iterar en un bucle aumentando en 2 el numero recibido hasta un límite
  //de 10 veces.
  //Guardar cada nuevo valor en un array.    
  //Devolver el array
  //Cuando el número de iteraciones alcance el valor 5, no se suma en ese 
  //caso y se continua con la siguiente iteración
